...
ENV GOOGLE_CLOUD_SDK_VERSION=$(curl -sL https://dl.google.com/dl/cloudsdk/channels/rapid/components-2.json | grep -oE '"version": "[0-9]+\.[0-9]+\.[0-9]+"' | head -n1 | grep -oE '[0-9]+\.[0-9]+\.[0-9]+')
