...
echo "ENV GOOGLE_CLOUD_SDK_VERSION=$(curl -Ls https://cloud.google.com/sdk/docs/quickstart | grep -oE 'google-cloud-sdk-[0-9]+\.[0-9]+\.[0-9]+-linux-x86_64.tar.gz' | grep -oE '[0-9]+\.[0-9]+\.[0-9]' | tail -n1)"
