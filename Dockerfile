...
ENV DYFF_VERSION=1.3.0
ENV EKSCTL_VERSION=0.47.0
ENV FLUXCD_VERSION=0.13.3
...
ENV ISTIOCTL_VERSION=1.9.4
ENV K9S_VERSION=v0.24.9
ENV KUBECTL_VERSION=v1.21.0
ENV KUBENT_VERSION=0.4.0
ENV KUBEVAL_VERSION=v0.16.1
ENV KUSTOMIZE_VERSION=v4.1.2
ENV SKAFFOLD_VERSION=v1.23.0
ENV SOPS_VERSION=v3.7.1
ENV TERRAFORM_VERSION=0.15.3
ENV TFENV_VERSION=2.2.1
ENV TFLINT_VERSION=v0.28.1
ENV TFSEC_VERSION=v0.39.29
ENV TF_SOPS_VERSION=0.6.2
ENV TRIVY_VERSION=0.17.2
ENV YQ3_VERSION=3.4.1
ENV YQ4_VERSION=v4.7.1
