...
ENV DYFF_VERSION=1.4.7
ENV EKSCTL_VERSION=v0.79.0
ENV FLUXCD_VERSION=0.25.3
ENV FLUXCTL_VERSION=1.24.3
ENV GOOGLE_CLOUD_SDK_VERSION=369.0.0
ENV HELM3_VERSION=v3.8.0-rc.2
ENV HELMFILE_VERSION=v0.143.0
ENV HELM_DIFF_VERSION=v3.3.2
ENV HELM_GIT_VERSION=v0.11.1
ENV HELM_PUSH_VERSION=v0.10.1
ENV HELM_SECRETS_VERSION=v2.0.3
ENV ISTIOCTL_VERSION=1.12.2
