...
ENV HELM3_VERSION=v3.3.0-rc.2
ENV HELMFILE_VERSION=v0.125.3
ENV HELM_2TO3_VERSION=v0.6.0
ENV HELM_DIFF_VERSION=v3.1.2
ENV HELM_GIT_VERSION=v0.8.1
ENV HELM_PUSH_VERSION=v0.8.1
ENV HELM_SECRETS_VERSION=v2.0.2
ENV ISTIOCTL_VERSION=1.6.7
ENV K9S_VERSION=v0.21.7
ENV KUBECTL_VERSION=v1.18.6
ENV SKAFFOLD_VERSION=v1.13.1
ENV SOPS_VERSION=v3.6.0
ENV TF_SOPS_VERSION=0.5.2
ENV YQ_VERSION=3.3.2

RUN apk --no-cache add bash bash-completion ca-certificates curl docker gettext git gnupg groff jq openssh-client openssl terraform vim
