...
ENV EKSCTL_VERSION=v0.70.0
ENV FLUXCD_VERSION=0.19.0
ENV FLUXCTL_VERSION=1.24.1
ENV GOOGLE_CLOUD_SDK_VERSION=361.0.0
ENV HELM3_VERSION=v3.7.1
ENV HELMFILE_VERSION=v0.141.0
ENV HELM_DIFF_VERSION=v3.1.3
ENV HELM_GIT_VERSION=v0.10.1
ENV HELM_PUSH_VERSION=v0.10.1
ENV HELM_SECRETS_VERSION=v2.0.3
ENV ISTIOCTL_VERSION=1.11.4
...
ENV SKAFFOLD_VERSION=v1.33.1
ENV SOPS_VERSION=v3.7.1
ENV STERN_VERSION=1.20.1
ENV TERRAFORM_VERSION=1.0.9
ENV TFENV_VERSION=2.2.2
ENV TFLINT_VERSION=v0.33.0
ENV TFSEC_VERSION=v0.58.14
ENV TF_SOPS_VERSION=0.6.3

# Trivy 0.20.1 has a bug where it reports a vulnerability with mongoose even though mongoose is not installed.
ENV TRIVY_VERSION=0.19.2

ENV YQ3_VERSION=3.4.1
ENV YQ4_VERSION=v4.13.5
